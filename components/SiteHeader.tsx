      ...
      >
        ...
        <div className="hidden md:block">
          {transparent ? (
            ...
            <Link
              href="/free-estimate"
              className="bg-white text-maroon text-[13px] font-semibold px-[22px] py-[11px] border border-white/50"
            >
              Free Estimate
            </Link>
          )}
        ...
        <div className="md:hidden bg-maroon border-t border-white/10">
          <div className="px-6 py-4 flex flex-col gap-3 text-white text-[15px] font-medium">
            ...
            <Link
              href="/free-estimate"
              onClick={() => setMobileOpen(false)}
              className="bg-white text-maroon text-[13px] font-semibold px-[22px] py-[11px] inline-block w-fit mt-2"
            >
              Free Estimate
            </Link>
          </div>
