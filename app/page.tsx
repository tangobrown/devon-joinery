    ...
    <>
      <section className="relative w-full min-h-[660px] flex flex-col overflow-hidden">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(180deg,rgba(15,17,20,0.62) 0%,rgba(15,17,20,0.35) 40%,rgba(15,17,20,0.62) 100%)",
          }}
        />
        ...
        <div className="relative z-10 flex-1 flex flex-col items-center justify-center text-center px-5 py-16 md:py-20 text-white">
          ...
          <div className="flex flex-wrap justify-center gap-3.5">
            <Link
              href="#expertise"
              className="bg-maroon-button text-white text-[14px] font-semibold px-6 py-3.5"
            >
              Our Expertise
            </Link>
            <Link
              href="/free-estimate"
              className="bg-[rgba(20,22,26,.55)] text-white text-[14px] font-semibold px-6 py-3.5 border border-white/25"
            >
              Free Estimate
            </Link>
          </div>
